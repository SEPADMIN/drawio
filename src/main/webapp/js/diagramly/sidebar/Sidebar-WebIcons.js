	...
	Sidebar.prototype.addWebIconsPalette = function()
	{
		...
		[
		 ...
		 this.createVertexTemplateEntry(s + 'drawio2;fillColor=#2174CE;gradientColor=#134277',
				 w * 512, h * 512, '', 'draw.io', null, null, this.getTagsForStencil(gn, 'sepadmin.github.io drawio draw io draw.io', dt).join(' ')),
	...
	Sidebar.prototype.addWebLogosPalette = function()
	{
		...
		[
		 ...
		 this.createVertexTemplateEntry(s + 'drawio2;fillColor=#1A5BA3',
				 w * 261, h * 354, '', 'draw.io', null, null, this.getTagsForStencil(gn, 'sepadmin.github.io drawio draw io draw.io', dt).join(' ')),
		 this.createVertexTemplateEntry(s + 'drawio3;fillColor=#1A5BA3;fontSize=15;fontColor=#1A5BA3;fontStyle=1',
				 w * 261, h * 261, 'diagrams.<font color="#f08707">net</font>', 'sepadmin.github.io', null, null, this.getTagsForStencil(gn, 'sepadmin.github.io drawio draw io draw.io', dt).join(' ')),
