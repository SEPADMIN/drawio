...
Sidebar.prototype.addGeneralPalette = function(expand)
{
	...
	var fns = [
 		...
 		this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;', 120, 80, '', 'KKKEllipse', null, null, 'KKKoval ellipse state'),
	    ...
	    this.createVertexTemplateEntry('shape=callout;whiteSpace=wrap;html=1;perimeter=calloutPerimeter;', 120, 80, '', 'Callout', null, null, 'bubble chat thought speech message'),
	 	...
	 	//this.createVertexTemplateEntry('shape=or;whiteSpace=wrap;html=1;', 60, 80, '', 'Reverse and', null, null, 'reverse logic and'),
